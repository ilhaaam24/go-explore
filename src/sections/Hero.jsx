      ...
      <div className=" flex flex-col-reverse gap-8 md:gap-0 md:flex-row items-center mt-24 ">
        <div className="">
          <motion.p
            ...
            transition={{ duration: 1, speed: 1, delay: 1, ease: "anticipate" }}
            className="uppercase font-poppins font-bold text-base md:text-lg lg:text-xl text-[#DF6951]">
            Best Destinations around the world
          </motion.p>
          <motion.div initial={{ opacity: 0, x: -100 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 1, speed: 2, ease: "easeIn" }} className="mt-6 relative">
          ...
          <Motion.p className="font-poppins font-medium text-base md:mt-4 lg:mt-8 leading-6 md:leading-7 lg:leading-8 max-w-[477px]">
